...
public class PathfindHolonomic extends PathfindingCommand {
     ...
     *            the target rotation of the robot based on the current trajectory
     *            state
     * @param constraints
     *            the path constraints to use while pathfinding
     * @param goalEndVel
     *            The goal end velocity when reaching the given pose
     * @param poseSupplier
     *            a supplier for the robot's current pose
     * @param currentRobotRelativeSpeeds
     *            a supplier for the robot's current robot relative speeds
     * @param output
     *            a consumer for the output speeds (field relative if holonomic,
     *            robot relative if
     *            differential)
     * @param config
     *            HolonomicPathFollowerConfig object with the configuration
     *            parameters for path
     *            following
     * @param requirements
