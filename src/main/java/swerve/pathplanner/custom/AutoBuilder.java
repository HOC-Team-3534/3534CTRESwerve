package swerve.pathplanner.custom;
...
public class AutoBuilder {
     ...
     *            a supplier for the robot's current robot relative chassis
     *            speeds
     * @param robotRelativeOutput
     *            a consumer for setting the robot's robot-relative chassis speeds
     * @param config
     *            {@link com.pathplanner.lib.util.HolonomicPathFollowerConfig} for
     *            configuring the
     *            path following commands
     * @param shouldFlipPath
     *            Supplier that determines if paths should be flipped to the other
     *            side of
     ...
     *            The function calculating the desired rotation given the current
     ...
     *            The distance the robot should move from the start position before
     ...
     *
     * @param pose
     *            The pose to pathfind to. This will be flipped if the path flipping
     *            supplier returns
     *            true
     * @param constraints
     *            The constraints to use while pathfinding
     ...
     *            The name of the auto that should be the default option. If this is
     *            an
     *            empty string, or if an auto with the given name does not exist,
